                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="toko" class="col-form-label">toko</label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                            <select name="toko" id="toko" class="form-control" style="margin-bottom:5px;" autofocus>
                                                <option value="" selected>--Pilih--</option>
                                                <?php foreach ($toko as $s) { ?>
                                                    <option value="<?= $s->toko_id; ?>"><?= $s->name; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
