                    ...
                    <tbody>
                        ...
                        foreach ($stock as $s) { ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-default btn-sm" id="select-detail" data-toggle="modal" data-target="#modal-detail" data-barcode="<?= $s->barcode; ?>" data-itemname=" <?= $s->item_name; ?>" data-tokoname="<?= $s->toko_name; ?>" data-qty="<?= $s->qty; ?>" data-date="<?= indo_date($s->date); ?>"><i class=" fa fa-eye"></i>
                                    </a>
